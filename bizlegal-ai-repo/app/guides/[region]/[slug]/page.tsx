...
function getJurisdictionData(region: string) {
  const data: Record<string, any> = {
    uae: {
      flag: '🇦🇪', name: 'UAE / DIFC', regulator: 'VARA / DFSA', color: '#fbbf24',
      stats: [
    ...
    'european-union': {
      flag: '🇪🇺', name: 'European Union', regulator: 'MiCA / ESMA', color: '#60a5fa',
      stats: [
    ...
    'united-states': {
      flag: '🇺🇸', name: 'United States', regulator: 'SEC / CFTC', color: '#4ade80',
      stats: [
    ...
    singapore: {
      flag: '🇸🇬', name: 'Singapore', regulator: 'MAS', color: '#f0abfc',
      stats: [
    ...
    'united-kingdom': {
      flag: '🇬🇧', name: 'United Kingdom', regulator: 'FCA', color: '#38bdf8',
      stats: [
    ...
    canada: {
      flag: '🇨🇦', name: 'Canada', regulator: 'CSA / FINTRAC', color: '#fb7185',
      stats: [
